...
const FilterData = (props) => {
  ...
  <ul className="button-list" style={{ listStyleType: "none", margin: 0, padding: 0, display: "flex", alignItems: "right",marginTop:"2%" }} onClick={buttonHandler}>
    ...
    <li style={{ marginRight: '25px' }}>
      ...
      <div>
        <div className="container" style={{ position: 'relative', top: "100px", marginLeft: "10%" }}>
            ...
            data.map((entry, index) => (
              <div
                ...
                style={{
                  ...
                  height: '150%',
                  left: `${index * .19}px`,
                  backgroundColor: entry.machine_status === 0 ? 'yellow' : entry.machine_status === null ? 'red' : 'green',
                }}
              >
